...
def generate_static_html():
    ...
    dataset_info = {
        ...
        "image_caption": "Global mean plant height in meters at 1 km resolution presented in Equal Area Scalable Earth (EASE) projection. Note that height is represented as the community-weighted mean, not maximum canopy height.",
        "abstract": """
